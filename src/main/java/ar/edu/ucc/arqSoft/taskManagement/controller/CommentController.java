...
public class CommentController {
	...
	public @ResponseBody ResponseEntity<Object> lookupCommentById(@PathVariable("id") Long id) {
		try {
			...
			GenericExceptionDto exDto = new GenericExceptionDto("1001", "Comment not found");
